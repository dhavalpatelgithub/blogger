...
export const metadata: Metadata = {
  title: 'Nested Blog Example',
  description: 'The nested blog website, which loves to present informative blogs.',
  openGraph: {
    title: "OG Nested Blog Example",
    images: ['https://socialprotection.gov.bd/wp-content/uploads/2017/07/dummy-member.jpg']
  }
};
