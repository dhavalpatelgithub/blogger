...
import Ol from "@/app/ui/blog/ol";
import H3 from "@/app/ui/blog/h3";
import H4 from "@/app/ui/blog/h4";
import Ul from "@/app/ui/blog/ul";
import Img from "@/app/ui/blog/img";
import Blockquote from "@/app/ui/blog/blockquote";
    ...
    <>
      <main className="pt-20 pb-16 lg:pt-20 lg:pb-24 bg-white dark:bg-gray-900 antialiased">
        <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
          <article key="blog" className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
